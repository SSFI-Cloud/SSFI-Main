...
export const seedDistricts = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const STATES_DISTRICTS = [
      ...
      { state: "Karnataka", code: "KA", districts: ["Bagalkot","Ballari","Bangalore Urban","Bangalore Rural","Belagavi","Bengaluru Rural","Bengaluru Urban","Bidar","Chamarajanagar","Chikkaballapur","Chikkamagaluru","Chitradurga","Dakshina Kannada","Davangere","Dharwad","Gadag","Hassan","Haveri","Kalaburagi","Kodagu","Kolar","Koppal","Mandya","Mysuru","Raichur","Ramanagara","Shivamogga","Tumakuru","Udupi","Uttara Kannada","Vijayapura","Yadgir"] },
